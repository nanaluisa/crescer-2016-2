...
namespace Repositorio
{
    public class RepositorioFuncionarios
    {
        ...
        {       
            List<Funcionario> listaFuncionarios = Funcionarios.Where(funcionario => funcionario.Cargo.Equals(cargo)).ToList();
        ...
        {
            List<Funcionario> listaFuncionarios = Funcionarios.OrderBy(funcionario => funcionario.Cargo.Titulo).ThenBy(funcionario => funcionario.Nome).ToList();
            return listaFuncionarios;
        ...
        {
            List<Funcionario> listaFuncionarios = Funcionarios.Where(funcionario => funcionario.TurnoTrabalho.Equals(turnos)).ToList();
            return listaFuncionarios;
        ...
        {
            int margem = 5;
            List<Funcionario> listaFuncionarios = Funcionarios.Where(funcionario => 
                                  (DateTime.Now.Year - (funcionario.DataNascimento.Year)) <= idade + margem &&
                                  (DateTime.Now.Year - (funcionario.DataNascimento.Year)) >= idade - margem).ToList();
            return listaFuncionarios;
